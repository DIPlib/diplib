#
# NOTE! This is a copy of the FindMatlab.cmake file that will be released (hopefully) with CMake v3.12.3
# It contains important changes that allow MEX-files to be compiled for MATLAB R2018a and R2018b.
#
# I've made two changes to let this run outside of the share/cmake/Modules directory:
# 1. The line:
#     include(${CMAKE_CURRENT_LIST_DIR}/FindPackageHandleStandardArgs.cmake)
# has become:
#     include(FindPackageHandleStandardArgs)
# 2. The file was renamed to "FindMatlab_new.cmake", requiring the use of:
#     find_package(Matlab_new ...)
# and requiring changing the variable `Matlab_FIND_COMPONENTS` to `Matlab_new_FIND_COMPONENTS`
...
list(FIND Matlab_new_FIND_COMPONENTS MEX_COMPILER _matlab_find_mex_compiler)
...
list(FIND Matlab_new_FIND_COMPONENTS MAIN_PROGRAM _matlab_find_matlab_program)
...
list(FIND Matlab_new_FIND_COMPONENTS ENG_LIBRARY _matlab_find_eng)
...
list(FIND Matlab_new_FIND_COMPONENTS MAT_LIBRARY _matlab_find_mat)
...
# Component Simulink
list(FIND Matlab_new_FIND_COMPONENTS SIMULINK _matlab_find_simulink)
...
list(FIND Matlab_new_FIND_COMPONENTS MCC_COMPILER _matlab_find_mcc_compiler)
