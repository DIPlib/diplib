#
# NOTE! This is a copy of the FindMatlab.cmake file that will be released with CMake v3.14.0.
# It contains important changes that allow MEX-files to be compiled for MATLAB R2018a and R2018b.
# See https://gitlab.kitware.com/cmake/cmake/merge_requests/2508
#
# To let this run outside of the share/cmake/Modules directory I had to make one change:
# The line:
  ...
  if(WIN32)
    ...
    if (MSVC)
      ...
      if(Matlab_HAS_CPP_API)
        ...
        #TODO: This causes linker errors when those functions are not defined.
      endif()
