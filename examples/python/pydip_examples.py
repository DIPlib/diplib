...
dip.viewer.Show(dip.Overlay(dip.Overlay(a, ~m), ~c, [0, 200, 0]), "overlay")
dip.viewer.Show(d1, "d1")
dip.viewer.Show(d2, "d2")
r1 = dip.GrowRegionsWeighted(b, a)
r2 = dip.GrowRegionsWeighted(b, a, m)
dip.viewer.Show(r1, "r1", lut="labels", mapping="8bit")
dip.viewer.Show(r2, "r2", lut="labels", mapping="8bit")
r3 = dip.GrowRegions(b)
r4 = dip.GrowRegions(b, m)
dip.viewer.Show(r3, "r3", lut="labels", mapping="8bit")
dip.viewer.Show(r4, "r4", lut="labels", mapping="8bit")
dip.viewer.Spin()
...
win2 = dip.viewer.Show(superpixels, "superpixels", link=win1)
win3 = dip.viewer.Show(output, "output", link=win2)
dip.viewer.Spin()
