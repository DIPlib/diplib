...
void init_filtering( py::module& m ) {
   ...
   m.def( "Gabor", py::overload_cast< dip::Image const&, dip::FloatArray const&, dip::dfloat, dip::dfloat, dip::StringArray const&, dip::BooleanArray const&, dip::dfloat >( &dip::Gabor ),
