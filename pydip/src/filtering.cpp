...
void init_filtering( py::module& m ) {
   ...
   m.def( "ConvolveFT", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::String const&, dip::String const&, dip::String const&, dip::StringArray const& >( &dip::ConvolveFT ),
          "in"_a, "filter"_a, py::kw_only(), "out"_a, "inRepresentation"_a = dip::S::SPATIAL, "filterRepresentation"_a = dip::S::SPATIAL, "outRepresentation"_a = dip::S::SPATIAL, "boundaryCondition"_a = dip::StringArray{} );
   m.def( "GeneralConvolution", py::overload_cast< dip::Image const&, dip::Image const&, dip::StringArray const& >( &dip::GeneralConvolution ),
          "in"_a, "filter"_a, "boundaryCondition"_a = dip::StringArray{} );
   m.def( "GeneralConvolution", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::StringArray const& >( &dip::GeneralConvolution ),
          "in"_a, "filter"_a, py::kw_only(), "out"_a, "boundaryCondition"_a = dip::StringArray{} );
   m.def( "Convolution", py::overload_cast< dip::Image const&, dip::Image const&, dip::String const&, dip::StringArray const& >( &dip::Convolution ),
          "in"_a, "filter"_a, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{} );
   m.def( "Convolution", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::String const&, dip::StringArray const& >( &dip::Convolution ),
          "in"_a, "filter"_a, py::kw_only(), "out"_a, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{} );
   ...
   m.def( "GaussIIR", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray, dip::UnsignedArray, dip::StringArray const&, dip::UnsignedArray, dip::String const&, dip::dfloat >( &dip::GaussIIR ),
          "in"_a, py::kw_only(), "out"_a, "sigmas"_a = dip::FloatArray{ 1.0 }, "derivativeOrder"_a = dip::UnsignedArray{ 0 }, "boundaryCondition"_a = dip::StringArray{}, "filterOrder"_a = dip::UnsignedArray{}, "designMethod"_a = dip::S::DISCRETE_TIME_FIT, "truncation"_a = 3.0 );
   ...
   m.def( "Gauss", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray, dip::UnsignedArray, dip::String const&, dip::StringArray const&, dip::dfloat >( &dip::Gauss ),
          "in"_a, py::kw_only(), "out"_a, "sigmas"_a = dip::FloatArray{ 1.0 }, "derivativeOrder"_a = dip::UnsignedArray{ 0 }, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{}, "truncation"_a = 3.0 );
   ...
   m.def( "FiniteDifference", py::overload_cast< dip::Image const&, dip::Image&, dip::UnsignedArray, dip::String const&, dip::StringArray const&, dip::BooleanArray >( &dip::FiniteDifference ),
          "in"_a, py::kw_only(), "out"_a, "derivativeOrder"_a = dip::UnsignedArray{ 0 }, "smoothFlag"_a = dip::S::SMOOTH, "boundaryCondition"_a = dip::StringArray{}, "process"_a = dip::BooleanArray{} );
   ...
   m.def( "SobelGradient", py::overload_cast< dip::Image const&, dip::Image&, dip::uint, dip::StringArray const& >( &dip::SobelGradient ),
          "in"_a, py::kw_only(), "out"_a, "dimension"_a = 0, "boundaryCondition"_a = dip::StringArray{} );
   ...
   m.def( "Derivative", py::overload_cast< dip::Image const&, dip::Image&, dip::UnsignedArray, dip::FloatArray, dip::String const&, dip::StringArray const&, dip::dfloat >( &dip::Derivative ),
          "in"_a, py::kw_only(), "out"_a, "derivativeOrder"_a = dip::UnsignedArray{ 0 }, "sigmas"_a = dip::FloatArray{ 1.0 }, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{}, "truncation"_a = 3.0 );
   m.def( "Dx", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dx ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dx", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dx ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dy", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dy ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dy", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dy ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dz", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dz ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dz", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dz ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dxx", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dxx ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dxx", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dxx ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dyy", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dyy ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dyy", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dyy ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dzz", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dzz ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dzz", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dzz ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dxy", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dxy ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dxy", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dxy ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dxz", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dxz ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dxz", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dxz ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   m.def( "Dyz", py::overload_cast< dip::Image const&, dip::FloatArray >( &dip::Dyz ), "in"_a, "sigma"_a = 1.0 );
   m.def( "Dyz", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray >( &dip::Dyz ), "in"_a, py::kw_only(), "out"_a, "sigma"_a = 1.0 );
   ...
   m.def( "Gradient", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray, dip::String const&, dip::StringArray const&, dip::BooleanArray, dip::dfloat >( &dip::Gradient ),
          "in"_a, py::kw_only(), "out"_a, "sigmas"_a = dip::FloatArray{ 1.0 }, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{}, "process"_a = dip::BooleanArray{}, "truncation"_a = 3.0 );
   ...
   m.def( "Sharpen", py::overload_cast< dip::Image const&, dip::Image&, dip::dfloat, dip::FloatArray, dip::String const&, dip::StringArray const&, dip::dfloat >( &dip::Sharpen ),
          "in"_a, py::kw_only(), "out"_a, "weight"_a = 1.0, "sigmas"_a = dip::FloatArray{ 1.0 }, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{}, "truncation"_a = 3.0 );
   ...
   m.def( "Gabor2D", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray, dip::dfloat, dip::dfloat, dip::StringArray const&, dip::dfloat >( &dip::Gabor2D ),
          "in"_a, py::kw_only(), "out"_a, "sigmas"_a = dip::FloatArray{ 5.0, 5.0 }, "frequency"_a = 0.1, "direction"_a = dip::pi, "boundaryCondition"_a = dip::StringArray{}, "truncation"_a = 3.0 );
   ...
   m.def( "MeanShiftVector", py::overload_cast< dip::Image const&, dip::Image&, dip::FloatArray, dip::String const&, dip::StringArray const&, dip::dfloat >( &dip::MeanShiftVector ),
          "in"_a, py::kw_only(), "out"_a, "sigmas"_a = dip::FloatArray{ 1.0 }, "method"_a = dip::S::BEST, "boundaryCondition"_a = dip::StringArray{}, "truncation"_a = 3.0 );
   ...
   m.def( "PercentileFilter", py::overload_cast< dip::Image const&, dip::Image&, dip::dfloat, dip::Kernel const&, dip::StringArray const& >( &dip::PercentileFilter ),
          "in"_a, py::kw_only(), "out"_a, "percentile"_a, "kernel"_a = dip::Kernel{}, "boundaryCondition"_a = dip::StringArray{} );
   ...
   m.def( "SelectionFilter", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::Kernel const&, dip::dfloat, dip::String const&, dip::StringArray const& >( &dip::SelectionFilter ),
          "in"_a, py::kw_only(), "out"_a, "control"_a, "kernel"_a = dip::Kernel{}, "threshold"_a = 0.0, "mode"_a = dip::S::MINIMUM, "boundaryCondition"_a = dip::StringArray{} );
   ...
   m.def( "Kuwahara", py::overload_cast< dip::Image const&, dip::Image&, dip::Kernel, dip::dfloat, dip::StringArray const& >( &dip::Kuwahara ),
          "in"_a, py::kw_only(), "out"_a, "kernel"_a = dip::Kernel{}, "threshold"_a = 0.0, "boundaryCondition"_a = dip::StringArray{} );
   ...
   m.def( "NonMaximumSuppression", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image const&, dip::Image&, dip::String const& >( &dip::NonMaximumSuppression ),
          "gradmag"_a, "gradient"_a, py::kw_only(), "mask"_a = dip::Image{}, "out"_a, "mode"_a = dip::S::INTERPOLATE );
   ...
   m.def( "MoveToLocalMinimum", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image& >( &dip::MoveToLocalMinimum ),
          "bin"_a, "weights"_a, py::kw_only(), "out"_a );
   ...
   m.def( "PeronaMalikDiffusion", py::overload_cast< dip::Image const&, dip::Image&, dip::uint, dip::dfloat, dip::dfloat, dip::String const& >( &dip::PeronaMalikDiffusion ),
          "in"_a, py::kw_only(), "out"_a, "iterations"_a = 5, "K"_a = 10, "stepSizeLambda"_a = 0.25, "g"_a = "Gauss" );
   ...
   m.def( "RobustAnisotropicDiffusion", py::overload_cast< dip::Image const&, dip::Image&, dip::uint, dip::dfloat, dip::dfloat >( &dip::RobustAnisotropicDiffusion ),
          "in"_a, py::kw_only(), "out"_a, "iterations"_a = 5, "sigma"_a = 10, "stepSizeLambda"_a = 0.25 );
   ...
   m.def( "CoherenceEnhancingDiffusion", py::overload_cast< dip::Image const&, dip::Image&, dip::dfloat, dip::dfloat, dip::uint, dip::StringSet const& >( &dip::CoherenceEnhancingDiffusion ),
          "in"_a, py::kw_only(), "out"_a, "derivativeSigma"_a = 1, "regularizationSigma"_a = 3, "iterations"_a = 5, "flags"_a = dip::StringSet{} );
   ...
   m.def( "AdaptiveGauss", py::overload_cast< dip::Image const&, dip::ImageConstRefArray const&, dip::Image&, dip::FloatArray const&, dip::UnsignedArray const&, dip::dfloat, dip::UnsignedArray const&, dip::String const&, dip::String const& >( &dip::AdaptiveGauss ),
          "in"_a, "params"_a, py::kw_only(), "out"_a, "sigmas"_a = dip::FloatArray{ 5.0, 1.0 }, "orders"_a = dip::UnsignedArray{ 0 }, "truncation"_a = 2.0, "exponents"_a = dip::UnsignedArray{ 0 }, "interpolationMethod"_a = dip::S::LINEAR, "boundaryCondition"_a = dip::S::SYMMETRIC_MIRROR );
   ...
   m.def( "BilateralFilter", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::FloatArray, dip::dfloat, dip::dfloat, dip::String const&, dip::StringArray const& >( &dip::BilateralFilter ),
          "in"_a, "estimate"_a, py::kw_only(), "out"_a, "spatialSigmas"_a = dip::FloatArray{ 2.0 }, "tonalSigma"_a = 30.0, "truncation"_a = 2.0, "method"_a = "xysep", "boundaryCondition"_a = dip::StringArray{} );
   ...
   m.def( "WienerDeconvolution", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image const&, dip::Image const&, dip::Image&, dip::StringSet const& >( &dip::WienerDeconvolution ),
          "in"_a, "psf"_a, "signalPower"_a, "noisePower"_a, py::kw_only(), "out"_a, "options"_a = dip::StringSet{ dip::S::PAD } );
   ...
   m.def( "WienerDeconvolution", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::dfloat, dip::StringSet const& >( &dip::WienerDeconvolution ),
          "in"_a, "psf"_a, py::kw_only(), "out"_a, "regularization"_a = 1e-4, "options"_a = dip::StringSet{ dip::S::PAD } );
   ...
   m.def( "TikhonovMiller", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::dfloat, dip::StringSet const& >( &dip::TikhonovMiller ),
          "in"_a, "psf"_a, py::kw_only(), "out"_a, "regularization"_a = 0.1, "options"_a = dip::StringSet{ dip::S::PAD } );
   ...
   m.def( "IterativeConstrainedTikhonovMiller", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::dfloat, dip::dfloat, dip::uint, dip::dfloat, dip::StringSet const& >( &dip::IterativeConstrainedTikhonovMiller ),
          "in"_a, "psf"_a, py::kw_only(), "out"_a, "regularization"_a = 0.1, "tolerance"_a = 1e-6, "maxIterations"_a = 30, "stepSize"_a = 0.0, "options"_a = dip::StringSet{ dip::S::PAD } );
   ...
   m.def( "RichardsonLucy", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::dfloat, dip::uint, dip::StringSet const& >( &dip::RichardsonLucy ),
          "in"_a, "psf"_a, py::kw_only(), "out"_a, "regularization"_a = 0.0, "nIterations"_a = 30, "options"_a = dip::StringSet{ dip::S::PAD } );
   ...
   m.def( "FastIterativeShrinkageThresholding", py::overload_cast< dip::Image const&, dip::Image const&, dip::Image&, dip::dfloat, dip::dfloat, dip::uint, dip::uint, dip::StringSet const& >( &dip::FastIterativeShrinkageThresholding ),
          "in"_a, "psf"_a, py::kw_only(), "out"_a, "regularization"_a = 0.1, "tolerance"_a = 1e-6, "maxIterations"_a = 30, "nScales"_a = 3, "options"_a = dip::StringSet{ dip::S::PAD } );
