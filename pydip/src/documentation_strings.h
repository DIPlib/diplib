...
constexpr char const* dip·GraphCut·Graph·CL·Graph·VertexIndex··Graph·VertexIndex· = "Computes the minimum cut of the graph, separating the source node from the\nsink node.";
