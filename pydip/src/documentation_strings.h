...
constexpr char const* dip·DirectedGraph·Vertex·Vertex·dip·uint· = "Construct a vertex with reserved space for the given number of edges.";
...
constexpr char const* dip·DirectedGraph·DirectedGraph·Image·CL·dip·uint··String·CL = "Construct a directed graph for the given image.";
...
constexpr char const* dip·DirectedGraph·EdgeIndices·VertexIndex··C = "Get the indices to the edges that start at vertex `v`.";
constexpr char const* dip·DirectedGraph·VertexValue·VertexIndex··C = "Returns a reference to the value of the vertex `v`. This value is mutable even\nif the graph is `const`.";
...
constexpr char const* dip·DirectedGraph·AddEdgePair·VertexIndex··VertexIndex··dfloat· = "Add an edge pair between vertices `v1` and `v2`, with weight `weight`. If the\nedges already exist, update their weights to be `weight`.";
constexpr char const* dip·DirectedGraph·AddEdgePairSumWeight·VertexIndex··VertexIndex··dfloat· = "Add an edge pair between vertices `v1` and `v2`, with weight `weight`. If the\nedges already exist, update their weight by adding `weight` to the existing\nweight.";
constexpr char const* dip·DirectedGraph·DeleteEdge·VertexIndex··VertexIndex· = "Delete the edge from vertex `source` to `target`.";
constexpr char const* dip·DirectedGraph·DeleteEdgePair·VertexIndex··VertexIndex· = "Delete both edges between vertex `v1` and `v2`.";
