...
constexpr char const* dip·LibraryInformation·name = "The library name";
...
constexpr char const* dip·LibraryInformation·type = "Describes options enabled during compilation";
...
constexpr char const* dip·viewer·ImageView = "";
...
constexpr char const* dip·viewer·SliceView = "";
...
constexpr char const* dip·viewer·ViewingOptions·ComplexToReal·Real = "";
constexpr char const* dip·viewer·ViewingOptions·ComplexToReal·Imaginary = "";
constexpr char const* dip·viewer·ViewingOptions·ComplexToReal·Magnitude = "";
constexpr char const* dip·viewer·ViewingOptions·ComplexToReal·Phase = "";
constexpr char const* dip·viewer·ViewingOptions·Mapping = "Grey-value mapping options";
constexpr char const* dip·viewer·ViewingOptions·Mapping·ZeroOne = "";
constexpr char const* dip·viewer·ViewingOptions·Mapping·Angle = "";
constexpr char const* dip·viewer·ViewingOptions·Mapping·Normal = "";
constexpr char const* dip·viewer·ViewingOptions·Mapping·Linear = "";
constexpr char const* dip·viewer·ViewingOptions·Mapping·Symmetric = "";
constexpr char const* dip·viewer·ViewingOptions·Mapping·Logarithmic = "";
constexpr char const* dip·viewer·ViewingOptions·Projection = "Slice projection options";
constexpr char const* dip·viewer·ViewingOptions·Projection·None = "";
constexpr char const* dip·viewer·ViewingOptions·Projection·Min = "";
constexpr char const* dip·viewer·ViewingOptions·Projection·Mean = "";
constexpr char const* dip·viewer·ViewingOptions·Projection·Max = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable = "Grey-value to color mapping options";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·ColorSpace = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·RGB = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·Grey = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·Sequential = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·Divergent = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·Cyclic = "";
constexpr char const* dip·viewer·ViewingOptions·LookupTable·Label = "";
constexpr char const* dip·viewer·ViewingOptions·Diff = "Defines which view (parts) need to be recalculated";
constexpr char const* dip·viewer·ViewingOptions·Diff·None = "";
constexpr char const* dip·viewer·ViewingOptions·Diff·Draw = "";
constexpr char const* dip·viewer·ViewingOptions·Diff·Place = "";
constexpr char const* dip·viewer·ViewingOptions·Diff·Mapping = "";
constexpr char const* dip·viewer·ViewingOptions·Diff·Projection = "";
constexpr char const* dip·viewer·ViewingOptions·Diff·Complex = "";
...
constexpr char const* dip·BoundaryCondition·SYMMETRIC_MIRROR = "";
constexpr char const* dip·BoundaryCondition·DEFAULT = "";
constexpr char const* dip·BoundaryCondition·ASYMMETRIC_MIRROR = "";
constexpr char const* dip·BoundaryCondition·PERIODIC = "";
constexpr char const* dip·BoundaryCondition·ASYMMETRIC_PERIODIC = "";
constexpr char const* dip·BoundaryCondition·ADD_ZEROS = "";
constexpr char const* dip·BoundaryCondition·ADD_MAX_VALUE = "";
constexpr char const* dip·BoundaryCondition·ADD_MIN_VALUE = "";
constexpr char const* dip·BoundaryCondition·ZERO_ORDER_EXTRAPOLATE = "";
constexpr char const* dip·BoundaryCondition·FIRST_ORDER_EXTRAPOLATE = "";
constexpr char const* dip·BoundaryCondition·SECOND_ORDER_EXTRAPOLATE = "";
constexpr char const* dip·BoundaryCondition·THIRD_ORDER_EXTRAPOLATE = "";
constexpr char const* dip·BoundaryCondition·ALREADY_EXPANDED = "";
...
constexpr char const* dip·Image·ReinterpretCast·dip·DataType· = "Changes the data type of `this` without changing or copying the data.";
...
constexpr char const* dip·operatorplus·Image·CL = "Unary operator, converts binary image to `dip::DT_UINT`, leaves other images\nunchanged.";
...
constexpr char const* dip·ChainCode·Polygon·C = "Returns a polygon representation of the object.";
...
constexpr char const* dip·NobleCornerDetector·Image·CL·Image·L·FloatArray·CL·StringArray·CL = "Noble's corner detector";
...
constexpr char const* dip·Graph·Vertex·Vertex·dip·uint· = "Construct a vertex with reserved space for the given number of edges.";
...
constexpr char const* dip·Graph·EdgeIndices·VertexIndex··C = "Get the indices to the edges that join vertex `v`.";
constexpr char const* dip·Graph·VertexValue·VertexIndex··C = "Returns a reference to the value of the vertex `v`. This value is mutable even\nif the graph is `const`.";
constexpr char const* dip·Graph·AddEdge·VertexIndex··VertexIndex··dfloat· = "Add an edge between vertices `v1` and `v2`, with weight `weight`. If the edge\nalready exists, update the weight of the edge to be `weight`.";
constexpr char const* dip·Graph·AddEdgeSumWeight·VertexIndex··VertexIndex··dfloat· = "Add an edge between vertices `v1` and `v2`, with weight `weight`. If the edge\nalready exists, update the weight of the edge by adding `weight` to the\nexisting weight.";
constexpr char const* dip·Graph·DeleteEdge·VertexIndex··VertexIndex· = "Delete the edge between vertices `v1` and `v2`.";
...
constexpr char const* dip·Graph·MinimumSpanningForest·std·vectorgtVertexIndexlt·CL·C = "Computes the minimum spanning forest (MSF) using Prim's algorithm.";
constexpr char const* dip·Graph·RemoveLargestEdges·dip·uint· = "Removes `number` edges with the largest weights from the graph.";
constexpr char const* dip·LowestCommonAncestorSolver = "Solves the lowest common ancestor problem for a tree.";
constexpr char const* dip·LowestCommonAncestorSolver·LowestCommonAncestorSolver·Graph·CL = "The constructor takes a `graph`, which must not have any cycles in it (it must\nbe a tree). The easiest way to turn an arbitrary graph into a tree is to\ncompute the MST (see `dip::Graph::MinimumSpanningForest`).";
constexpr char const* dip·LowestCommonAncestorSolver·GetLCA·dip·uint··dip·uint··C = "Returns the vertex that is the nearest common ancestor to vertices `a` and\n`b`.";
constexpr char const* dip·LowestCommonAncestorSolver·GetLogF·dip·uint··C = "Returns the value associated to the vertex `index`. TODO: describe this value!";
...
constexpr char const* dip·Dyz·Image·CL·Image·L·FloatArray· = "Computes the first derivative along y and y, see `dip::Derivative`.";
