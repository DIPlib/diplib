...
DOCTEST_TEST_CASE("[DIPlib] testing the dip::div_{floor|ceil|round} functions") {
   DOCTEST_CHECK( dip::div_ceil( 11u, 11u ) == 1 );
   DOCTEST_CHECK( dip::div_ceil( 11u, 6u ) == 2 );
   DOCTEST_CHECK( dip::div_ceil( 11u, 5u ) == 3 );
   DOCTEST_CHECK( dip::div_ceil( 11u, 4u ) == 3 );
   DOCTEST_CHECK( dip::div_ceil( 11u, 3u ) == 4 );
   DOCTEST_CHECK( dip::div_ceil( 11, 11 ) == 1 );
   DOCTEST_CHECK( dip::div_ceil( 11, 6 ) == 2 );
   DOCTEST_CHECK( dip::div_ceil( 11, 5 ) == 3 );
   DOCTEST_CHECK( dip::div_ceil( 11, 4 ) == 3 );
   DOCTEST_CHECK( dip::div_ceil( 11, 3 ) == 4 );
   DOCTEST_CHECK( dip::div_ceil( -11, 3 ) == -3 );
   DOCTEST_CHECK( dip::div_ceil( -11, 4 ) == -2 );
   DOCTEST_CHECK( dip::div_ceil( -11, 5 ) == -2 );
   DOCTEST_CHECK( dip::div_ceil( -11, 6 ) == -1 );
   DOCTEST_CHECK( dip::div_ceil( 11, -3 ) == -3 );
   DOCTEST_CHECK( dip::div_ceil( 11, -4 ) == -2 );
   DOCTEST_CHECK( dip::div_ceil( 11, -5 ) == -2 );
   DOCTEST_CHECK( dip::div_ceil( 11, -6 ) == -1 );
   ...
   DOCTEST_CHECK( dip::div_ceil( -11, -4 ) == 3 );
   DOCTEST_CHECK( dip::div_ceil( -11, -3 ) == 4 );
   DOCTEST_CHECK( dip::div_ceil( 0u, 5u ) == 0 );
   DOCTEST_CHECK( dip::div_ceil( 5u, 5u ) == 1 );
   DOCTEST_CHECK( dip::div_ceil( 0, 5 ) == 0 );
   DOCTEST_CHECK( dip::div_ceil( 0, -5 ) == 0 );
   DOCTEST_CHECK( dip::div_ceil( 5, 5 ) == 1 );
   DOCTEST_CHECK( dip::div_ceil( 5, -5 ) == -1 );
   DOCTEST_CHECK( dip::div_ceil( -5, 5 ) == -1 );
   DOCTEST_CHECK( dip::div_ceil( -5, -5 ) == 1 );

   DOCTEST_CHECK( dip::div_floor( 10u, 10u ) == 1 );
   DOCTEST_CHECK( dip::div_floor( 11u, 6u ) == 1 );
   DOCTEST_CHECK( dip::div_floor( 11u, 5u ) == 2 );
   DOCTEST_CHECK( dip::div_floor( 11u, 4u ) == 2 );
   DOCTEST_CHECK( dip::div_floor( 11u, 3u ) == 3 );
   DOCTEST_CHECK( dip::div_floor( 10, 10 ) == 1 );
   DOCTEST_CHECK( dip::div_floor( 11, 6 ) == 1 );
   DOCTEST_CHECK( dip::div_floor( 11, 5 ) == 2 );
   DOCTEST_CHECK( dip::div_floor( 11, 4 ) == 2 );
   DOCTEST_CHECK( dip::div_floor( 11, 3 ) == 3 );
   DOCTEST_CHECK( dip::div_floor( -11, 3 ) == -4 );
   DOCTEST_CHECK( dip::div_floor( -11, 4 ) == -3 );
   DOCTEST_CHECK( dip::div_floor( -11, 5 ) == -3 );
   DOCTEST_CHECK( dip::div_floor( -11, 6 ) == -2 );
   DOCTEST_CHECK( dip::div_floor( 11, -3 ) == -4 );
   DOCTEST_CHECK( dip::div_floor( 11, -4 ) == -3 );
   DOCTEST_CHECK( dip::div_floor( 11, -5 ) == -3 );
   DOCTEST_CHECK( dip::div_floor( 11, -6 ) == -2 );
   ...
   DOCTEST_CHECK( dip::div_floor( -11, -4 ) == 2 );
   DOCTEST_CHECK( dip::div_floor( -11, -3 ) == 3 );
   DOCTEST_CHECK( dip::div_floor( 0u, 5u ) == 0 );
   DOCTEST_CHECK( dip::div_floor( 5u, 5u ) == 1 );
   DOCTEST_CHECK( dip::div_floor( 0, 5 ) == 0 );
   DOCTEST_CHECK( dip::div_floor( 0, -5 ) == 0 );
   DOCTEST_CHECK( dip::div_floor( 5, 5 ) == 1 );
   DOCTEST_CHECK( dip::div_floor( 5, -5 ) == -1 );
   DOCTEST_CHECK( dip::div_floor( -5, 5 ) == -1 );
   DOCTEST_CHECK( dip::div_floor( -5, -5 ) == 1 );

   DOCTEST_CHECK( dip::div_round( 10u, 10u ) == 1 );
   DOCTEST_CHECK( dip::div_round( 11u, 6u ) == 2 );
   DOCTEST_CHECK( dip::div_round( 11u, 5u ) == 2 );
   DOCTEST_CHECK( dip::div_round( 11u, 4u ) == 3 );
   DOCTEST_CHECK( dip::div_round( 11u, 3u ) == 4 );
   DOCTEST_CHECK( dip::div_round( 10, 10 ) == 1 );
   DOCTEST_CHECK( dip::div_round( 11, 6 ) == 2 );
   DOCTEST_CHECK( dip::div_round( 11, 5 ) == 2 );
   DOCTEST_CHECK( dip::div_round( 11, 4 ) == 3 );
   DOCTEST_CHECK( dip::div_round( 11, 3 ) == 4 );
   DOCTEST_CHECK( dip::div_round( -11, 3 ) == -4 );
   DOCTEST_CHECK( dip::div_round( -11, 4 ) == -3 );
   DOCTEST_CHECK( dip::div_round( -11, 5 ) == -2 );
   DOCTEST_CHECK( dip::div_round( -11, 6 ) == -2 );
   ...
   DOCTEST_CHECK( dip::div_round( -11, -4 ) == 3 );
   DOCTEST_CHECK( dip::div_round( -11, -3 ) == 4 );
   DOCTEST_CHECK( dip::div_round( 0u, 5u ) == 0 );
   DOCTEST_CHECK( dip::div_round( 5u, 5u ) == 1 );
   DOCTEST_CHECK( dip::div_round( 0, 5 ) == 0 );
   DOCTEST_CHECK( dip::div_round( 0, -5 ) == 0 );
   DOCTEST_CHECK( dip::div_round( 5, 5 ) == 1 );
   DOCTEST_CHECK( dip::div_round( 5, -5 ) == -1 );
   DOCTEST_CHECK( dip::div_round( -5, 5 ) == -1 );
   DOCTEST_CHECK( dip::div_round( -5, -5 ) == 1 );
