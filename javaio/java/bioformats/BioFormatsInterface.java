...
public class BioFormatsInterface {
   public static FileInformation Read( String file, int imageNumber, long pointer ) throws Exception {
      ...
      reader.setId( file );
      int nImages = reader.getSeriesCount();
      // TODO: Do we need to test this here? if( imageNumber >= nImages ) { throw }
      reader.setSeries( imageNumber );
