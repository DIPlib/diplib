...
/// - `""`: Examine the file name extension, if it is ".ics" or ".ids", assume it is an ICS file, if it is
///         ".tif" or ".tiff", assume it's a TIFF file, otherwise try reading with the *Bio-Formats* library.
///         This is the default.
///
...
/// - `""`: Examine the file name extension, if it is ".ics" or ".ids", create an ICS file, if it is
///         ".tif" or ".tiff", create a TIFF file. If no extension is present, it defaults to ICS.
///         This is the default.
///
...
///
/// The TIFF can store 2D images, as well as 3D images as a series of 2D slides (not yet implemented). Most
