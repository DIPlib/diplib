...
/// `outTensorLength`, and the output tensor size is guaranteed to match the
/// largest input tensor. `nTensorElements` is ignored.
///
...
///
/// `functionParameters` is a `void*` pointing at user data. This pointer will
