...
%
% SYNOPSIS:
%  image_out = varif(image_in,filterSize,filterShape,boundary_condition)
%  image_out = varif(image_in,neighborhood,boundary_condition)
%
% PARAMETERS:
...
%
% DIPlib:
%  This function calls the DIPlib function <a href="https://diplib.org/diplib-docs/nonlinear.html#dip-VarianceFilter-Image-CL-Image-L-Kernel-CL-StringArray-CL">dip::VarianceFilter</a>.
