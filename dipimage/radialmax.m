...
%
% SYNOPSIS:
%  image_out = radialmax(image_in,mask,binSize,maxRadius,center)
%  image_out = radialmax(image_in,binSize,maxRadius,center)
%
% PARAMETERS:
...
%
% DIPlib:
%  This function calls the DIPlib function <a href="https://diplib.org/diplib-docs/math_projection.html#dip-RadialMaximum-Image-CL-Image-CL-Image-L-dfloat--String-CL-FloatArray-CL">dip::RadialMaximum</a>.
...
function out = radialmax(varargin)
out = dip_math('radialmax',varargin{:});
