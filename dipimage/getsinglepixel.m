...
%
% SYNOPSIS:
%  image_out = getsinglepixel(image_in, connectivity, edgeCondition)
%
% PARAMETERS:
...
function image_out = getsinglepixel(image_in, connectivity, edgeCondition)
if nargin < 3
   edgeCondition = "background";
   if nargin < 2
      connectivity = 0;
...
image_out = ( countneighbors(image_in,"foreground",connectivity,edgeCondition) == 1 );
