...
%
% DIPlib:
%  This function calls the DIPlib function <a href="https://diplib.org/diplib-docs/morphology.html#dip-Dilation-Image-CL-Image-L-StructuringElement-CL-StringArray-CL">dip::Dilation</a>.
...
function out = dilation(varargin)
out = dip_morphology('dilation',varargin{:});
