...
%
% SYNOPSIS:
%  image_out = rankmin_closing(image_in,rank,filterSize,filterShape,boundary_condition)
%  image_out = rankmin_closing(image_in,rank,image_se,boundary_condition)
%
% PARAMETERS:
...
function out = rankmin_closing(varargin)
out = dip_morphology('rankmin_closing',varargin{:});
