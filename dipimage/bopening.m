...
%
% SYNOPSIS:
%  image_out = bopening(image_in,iterations,connectivity,edgeCondition)
%
% PARAMETERS:
...
%
% DIPlib:
%  This function calls the DIPlib function dip::BinaryOpening
...
function out = bopening(varargin)
out = dip_morphology('bopening',varargin{:});
