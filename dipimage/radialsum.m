...
%
% SYNOPSIS:
%  image_out = radialsum(image_in,mask,binSize,maxRadius,center)
%  image_out = radialsum(image_in,binSize,maxRadius,center)
%
% PARAMETERS:
...
%
% DIPlib:
%  This function calls the DIPlib function <a href="https://diplib.org/diplib-docs/math_projection.html#dip-RadialSum-Image-CL-Image-CL-Image-L-dfloat--String-CL-FloatArray-CL">dip::RadialSum</a>.
...
function out = radialsum(varargin)
out = dip_math('radialsum',varargin{:});
