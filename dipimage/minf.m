...
%
% SYNOPSIS:
%  image_out = minf(image_in,filterSize,filterShape,boundary_condition)
%  image_out = minf(image_in,neighborhood,boundary_condition)
%
% PARAMETERS:
