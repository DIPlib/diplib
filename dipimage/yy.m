...
%
%   YY(...,ORIGIN) allows specifying where the origin is:
...
%
%   YY(...,ORIGIN,OPTIONS) further specifies one or both of these options:
...
%  'math' option. That is, YY(...,'mleft') is equivalent to
%  YY(...,'left','math').
%
% SEE ALSO:
%  coordinates, ramp, xx, zz, rr, phiphi, thetatheta
