...
menulist = {...
   'File I/O',{'readim','readroiim','readtimeseries','readrawim','writeim','-',...
      'readavi','writeavi','writedisplayavi','-','macro','-','reload','exit'};...
      ... % Note that 'macro', 'reload' and 'exit' are internal functions to dipimage.
   'Display',{'overlay','overlay_confidence','overlay_vector','-',...
      'orientationplot','-',...
      'dipgetcoords','dipdrawpolygon','diproi','-','diptruesize','dipclf'};...
   'Generation',{'newim','newcolorim','newtensorim','-',...
      'deltaim','ramp','xx','yy','zz','rr','phiphi','thetatheta','-',...
      'testobject','-','setborder','-',...
      'noise','drawline','drawpolygon','drawshape','gaussianblob'};...
   'Manipulation',{'mirror','shift','correctshift','localshift','-',...
      'rotation','rotation3d','skew','affine_trans','-',...
      'resample','subsample','rebin','split','get_subpixel','-','extend','cut'};...
   'Point',{'#Image Arithmetic','#Image Comparison','#Tensor Arithmetic','-','clip','erfclip','gaussianedgeclip','gaussianlineclip','-',...
      'stretch','hist_equalize','-','lut'};...
   'Image Arithmetic',{'plus','minus','times','rdivide','mod','power','-',...
      'and','or','xor','-','atan2','hypot','-',...
   ...
   'Differential Filters',{'derivative','-',...
      ...
      'hessian','dethessian','laplace','laplace_plus_dgg','laplace_min_dgg','-','curl','divergence','-',...
      'prewittf','sobelf'};...
   ...
   'Statistics',{'sum','prod','mean','median','percentile','max','min','std','var','any','all','-',...
      'diphist','diphist2d','-','getmaximumandminimum','getsamplestatistics','-',...
...
%TODO: 'readroiim','readrawim'
%TODO: 'readavi','writeavi','writedisplayavi'
...
functionlist('cut') = struct(...
   ...
   'outparams',{{'Output image'}});
%TODO: 'correctshift','localshift','rotation3d','affine_trans'
...
functionlist('bpropagation') = struct(...
   ...
   'inparams',struct('description',{'Seed image', 'Mask image','Iterations','Connectivity','Edge Condition'},...
                     ...
                     'constraint', {'bin',        'bin',       [],          [],            {'background','object'}},...
...
functionlist('traceobjects') = struct(...
   ...
   'inparams',struct('description',{'Input image', 'Labels','Connectivity','Output'},...
                     ...
                     'default',    {'a',           [],      2,             'polygon'}),...
   'outparams',{{'Traces'}});
%TODO: 'hist2image','splitandmerge','countingframe'
...
functionlist('gdt') = struct(...
   ...
   'inparams',struct('description',{'Input image','Weight image','Chamfer Size'},...
                     ...
                     'default',    {'a',          'b',           3}),...
   'outparams',{{'Output image'}});
%TODO: 'nufft_type1','nufft_type2','ht','radoncircle'
...
%TODO: 'granulometry','find_affine_trans','fmmatch'
...
functionlist('diphist2d') = struct(...
   ...
   'inparams',struct('description',{'Channel 1','Channel 2','Mask', 'Range 1 [min max]','Range 2 [min max]','Bins 1','Bins 2','Contour plot','Log plot','Filled contours','Labeled contours','Number of contours'},...
                     ...
                     'constraint', {'scalar',   'scalar',   [],     [],                 [],                 [],      [],      [],            {'none','x-axis','y-axis','z-axis','xy-axes','xyz-axes'},[],[],[]},...
...
functionlist('entropy') = struct(...
   ...
   'inparams',struct('description',{'Input image',    'Number of histogram bins'},...
                     ...
                     'default',    {'a',              256}),...
   'outparams',{{'Entropy'}});
%TODO: 'chordlength','paircorrelation'
%TODO: 'cal_readnoise'
