...
menulist = {...
   ...
   'Point',{'clip','erfclip','gaussianedgeclip','gaussianlineclip','-',...
      'stretch','hist_equalize','-','lut','get_subpixel'};...
      ... #TODO: add arithmetic, tensor algebra, etc. We can add dip_image methods now too!
   ...
   'Statistics',{'diphist','diphist2d','-',...
      'getmaximumandminimum','getsamplestatistics','-',...
...
functionlist('overlay') = struct(...
   ...
   'inparams',struct('description',{'Grey or color image','Binary or labelled image','Color'},...
...
%'overlay_confidence','overlay_vector','orientationplot'
...
functionlist('cut') = struct(...
   ...
   'outparams',{{'Output image'}});
%'correctshift','localshift','rotation3d','affine_trans'
...
functionlist('sobelf') = struct(...
   ...
   'inparams',struct('description',{'Input image','Derivative dimension'},...
                     ...
                     'default',    {'a',          1}),...
   'outparams',{{'Output image'}});
%'dgg','dcc','laplace_plus_dgg','laplace_min_dgg'
...
% Filters/Diffusion
%'pmd','pmd_gaussian','aniso','mcd','cpf','ced'

% Filters/Restoration
%'wiener','mappg','tikhonovmiller','backgroundoffset','afm_flatten'
...
functionlist('relabel') = struct(...
   ...
   'inparams',struct('description',{'Input image'},...
                     ...
                     'default',    {'a'}),...
   'outparams',{{'Output image'}});
%'hist2image','splitandmerge','canny'
%'snakeminimize','gvf','vfc','snakedraw','snake2im','im2snake'
%'countingframe'
...
functionlist('gdt') = struct(...
   ...
   'inparams',struct('description',{'Input image','Weight image','Chamfer Size'},...
                     ...
                     'default',    {'a',          'b',           3}),...
   'outparams',{{'Output image'}});
%'nufft_type1','nufft_type2','ht','radoncircle'
...
functionlist('subpixlocation') = struct(...
   ...
   'outparams',{{'Output coordinate array'}});
%'msr2ds','scalespace','morphscales','scale2rgb'
%'structuretensor','curvature','pst','quadraturetensor'
%'granulometry','find_affine_trans','fmmatch'
%'opticflow','findlocalshift','findlocmax'
