...
%
% SYNOPSIS:
%  image_out = berosion(image_in,iterations,connectivity,edgeCondition)
%  image_out = berosion(image_in,distance,'isotropic')
%
% PARAMETERS:
...
%
% DIPlib:
%  This function calls the DIPlib function <a href="https://diplib.org/diplib-docs/binary.html#dip-BinaryErosion-Image-CL-Image-L-dip-sint--dip-uint--String-CL">dip::BinaryErosion</a> and
%  <a href="https://diplib.org/diplib-docs/binary.html#dip-IsotropicErosion-Image-CL-Image-L-dfloat-">dip::IsotropicErosion</a>.
...
function out = berosion(varargin)
out = dip_morphology('berosion',varargin{:});
